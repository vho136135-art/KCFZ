    ...
    <div class="content-container">
        ...
        <div class="allInf01" style="display: flex;">
          ...
          <div style="display: flex;flex-direction: column;width: 19vw;margin-right: 0.7vw;margin-left: 1vw;">
            <div class="back">
              ...
              <div>
                <div class="formaction">
                  最大距离 (km)
                  <el-input style="margin-right: 1vw;" v-model="maxRange" autocomplete="off" @focus="onFocus"
                            @blur="onBlur"></el-input>
                </div>
                <div class="formaction">
                  最大高度 (m)
                  <el-input style="margin-right: 1vw;" v-model="maxAltitude" autocomplete="off" @focus="onFocus"
                            @blur="onBlur"></el-input>
                </div>
              </div>
            </div>
            <div class="back">
              ...
              <div class="formaction">
                3dB波束宽度 (deg)
                <el-input style="margin-right: 1vw;" v-model="beamwidth" autocomplete="off" @focus="onFocus"
                          @blur="onBlur"></el-input>
              </div>
              <div class="formaction">
                仰角 (deg)
                <el-input style="margin-right: 1vw;" v-model="elevation_angle" autocomplete="off" @focus="onFocus"
                          @blur="onBlur"></el-input>
              </div>
              <div class="formaction">
                天线高度 (m)
                <el-input style="margin-right: 1vw;" v-model="antenna_height" autocomplete="off" @focus="onFocus"
                          @blur="onBlur"></el-input>
              </div>
              <div class="formaction">
                频率 (MHz)
                <el-input style="margin-right: 1vw;" v-model="frequency" autocomplete="off" @focus="onFocus"
                          @blur="onBlur"></el-input>
              </div>
            ...
            <div class="back">
              ...
              <div>
                ...
                <div class="formaction"
                     style="display: flex;margin: 0 1vw;padding: 0;justify-content: space-around;width: 90%;">
                ...
                <div class="formaction" style="padding: 0 3.7vw 0 3.1vw;width: 11vw">
                  <div>
                    <el-input v-model="Range" autocomplete="off" @focus="onFocus" @blur="onBlur"
                              :disabled="this.refractivity_type !== 'Range-dep.refractivity'"
                              style="width: 3.7vw;margin-left: -0.5vw;"></el-input>
                  </div>
                  <div style="width: 5.5vw;text-align: left;color: #fff;"
                       @click="refractivity_type === 'Range-dep.refractivity'?showAtmosphereOptionP():null"
                       @focus="onFocus"
                       @blur="onBlur" tabindex="0">
                ...
                <div class="atmosphere-table">
                  <table>
                    ...
                    <tr v-for="(item, index) in atmosphereTable" :key="index">
                      <td>
                        <el-input type="text" v-model="item.range"
                                  :disabled="refractivity_type !== 'Range-dep.refractivity'"/>
                      </td>
                      <td>
                        <el-input type="text" v-model="item.profile" class="inputTz" style="width: 9vw;"
                                  :disabled="refractivity_type !== 'Range-dep.refractivity'"/>
                      </td>
                    </tr>
                    </tbody>
          ...
          <div style="display: flex;flex-direction: column;width: 19vw;margin-right: 0.7vw;">
            <div class="back">
              ...
              <div>
                ...
                <div class="formaction">
                  距离步长(m)
                  <el-input style="margin-right: 1vw;" v-model="range_step" autocomplete="off" @focus="onFocus"
                            @blur="onBlur"></el-input>
                </div>
                <div class="formaction">
                  高度步长 (m)
                  <el-input style="margin-right: 1vw;" v-model="altitude_step" autocomplete="off" @focus="onFocus"
                            @blur="onBlur"></el-input>
                </div>
              </div>
            </div>
            <div class="back">
              ...
              <div class="formaction">
                介电常数
                <el-input style="margin-right: 1vw;" v-model="dielectric_constant" autocomplete="off" @focus="onFocus"
                          @blur="onBlur"></el-input>
              </div>
              <div class="formaction">
                电导率 (s/m)
                <el-input style="margin-right: 1vw;" v-model="conductivity" autocomplete="off" @focus="onFocus"
                          @blur="onBlur"></el-input>
              </div>
            </div>
            <div class="back" style="height: 40vh;">
              ...
              <div>
                <div class="formaction1">
                  <el-radio v-model="terrain_type" label="None (Flat)" style="margin-left: 0.8vw;">无（平坦地形）
                  </el-radio>
                ...
                <div class="formaction" style="width: 80%;">
                  ...
                  <div>
                    <el-input style="margin-right: 1vw;" v-model="num_points" @focus="onFocus"
                              @blur="onBlur"></el-input>
                  </div>
                </div>
                <div class="formaction"
                     style="display: flex;margin: 0 2vw;padding: 0;justify-content: space-between;width: 78%;">
                ...
                <div class="formaction" style="width: 88%;">
                  <div>
                    <el-input style="margin-right: 1vw;margin-left: 0.6vw;" v-model="tRange" autocomplete="off"
                              @focus="onFocus" @blur="onBlur"></el-input>
                  </div>
                  <div>
                    <el-input style="margin-right: 2.5vw;" v-model="Height" autocomplete="off" @focus="onFocus"
                              @blur="onBlur"></el-input>
                  </div>
                </div>
                <div class="terrain-table">
                  <table>
                    ...
                    <tr v-for="(item, index) in terrainTable" :key="index">
                      ...
                      <td>
                        <el-input type="text" v-model="item.height"/>
                      </td>
                    </tr>
                    </tbody>
                  </table>
            ...
            <div>
              ...
              <div style="display: flex;margin-bottom: 1vh;justify-content: center">
                <div class="picture-container"
                     style="display: flex; justify-content: center; width: 100%;background-color: #FFFFFF;border: 2px solid  #006cda;">
      ...
      <el-dialog :visible.sync="dialogSAPVisible" class="showInfo1">
        <div style="display: flex; flex-direction: row">
          <div
              style="color: #fff; background-color: #004e9c;border-radius: 20px;width: 10vw; height: 3.7vh;align-items: center;justify-content: center; font-size: 20px;margin-top: -2%">
            <div style="margin-left: 20%;margin-top: 2%;width: 100%;">
              标准大气
            </div>
          </div>
          <el-button size="small"
                     style="width: 3vw;height:3vh;display: flex;justify-content: center;background-color: #f19149;color: #FFFFFF;margin-top: -1%; margin-left: 50%"
                     @click="DQ2">绘图
          </el-button>
          <el-button size="small" @click="dialogSDVisible = false"
                     style="width: 3vw;height:3vh;display: flex;justify-content: center;background-color: #004e9c;color: #FFFFFF;margin-top: -1%">
            确定
          </el-button>
          <el-button size="small" @click="dialogSDVisible = false"
                     style="width: 3vw;height:3vh;display: flex;justify-content: center;background-color: #004e9c;color: #FFFFFF;margin-top: -1%">
          ...
          <el-button size="small" @click="save2"
                     style="width: 3vw;height:3vh;display: flex;justify-content: center;background-color: #004e9c;color: #FFFFFF;margin-top: -1%">
            保存
          </el-button>
        </div>
          ...
          <div style="margin-left: 2vw;width: 30%">
            <el-form :model="form1" style="width: 100%">
              <div>
                ...
                <input v-model="form1.Range"
                       style="width: 14vw; border:2px #004e9c solid; border-radius: 20px; height: 3vh;margin-top: 1vh"/>
              </div>
              <div
                  style="display: flex;flex-direction: row;justify-content: space-between;align-items: center;margin-top: 4vh"
                  class="doubleForm">
              ...
              <div style="display: flex;flex-direction: row;justify-content: space-between;align-items: center;">
                ...
                <input v-model="form1.M_entry"
                       style="width: 5vw; border:2px #004e9c solid; border-radius: 20px; height: 3vh;margin-top: 1vh"/>
                <div style="color: black">Z0</div>
                <input v-model="form1.altitude_entry"
                       style="width: 5vw; border:2px #004e9c solid; border-radius: 20px; height: 3vh;margin-top: 1vh"/>
              </div>
        ...
        <div style="display: flex; flex-direction: row; margin-top: 4%">
          <div style="margin-left: 2vw;width: 30%">
            <el-form :model="form2" style="width: 100%">
              ...
              <div
                  style="display: flex;flex-direction: row;justify-content: space-between;align-items: center;margin-top: 3vh">
                <div style="color: black">M0</div>
                <input v-model="form2.S_M_entry"
                       style="width: 5vw; border:2px #004e9c solid; border-radius: 20px; height: 3vh;margin-top: 1vh"/>
                <div style="color: black">Z0</div>
                <input v-model="form2.s_altitude_entry"
                       style="width: 5vw; border:2px #004e9c solid; border-radius: 20px; height: 3vh;margin-top: 1vh"/>
              </div>
              <div
                  style="display: flex;flex-direction: row;justify-content: space-between;align-items: center;margin-top: 3vh">
                <div style="color: black">M1</div>
                <input v-model="form2.S_M_entry1"
                       style="width: 5vw; border:2px #004e9c solid; border-radius: 20px; height: 3vh;margin-top: 1vh"/>
                <div style="color: black">Z1</div>
                <input v-model="form2.s_altitude_entry1"
                       style="width: 5vw; border:2px #004e9c solid; border-radius: 20px; height: 3vh;margin-top: 1vh"/>
              </div>
              <div
                  style="display: flex;flex-direction: row;justify-content: space-between;align-items: center;margin-top: 3vh">
                <div style="color: black">M2</div>
                <input v-model="form2.S_M_entry2"
                       style="width: 5vw; border:2px #004e9c solid; border-radius: 20px; height: 3vh;margin-top: 1vh"/>
                <div style="color: black">Z2</div>
                <input v-model="form2.s_altitude_entry2"
                       style="width: 5vw; border:2px #004e9c solid; border-radius: 20px; height: 3vh;margin-top: 1vh"/>
              </div>
        ...
        <div style="display: flex; flex-direction: row;margin-top: 4%">
          <div style="margin-left: 2vw;width: 30%">
            <el-form :model="form3" style="width: 100%">
              ...
              <div>
                <div style="color: black">范围(km)</div>
                <input v-model="form3.Range"
                       style="width: 14vw; border:2px #004e9c solid; border-radius: 20px; height: 3vh;margin-top: 1vh"/>
              </div>
              <div style="margin-top: 3vh">
                <div style="color: black">M</div>
                <input v-model="form3.name"
                       style="width: 14vw; border:2px #004e9c solid; border-radius: 20px; height: 3vh;margin-top: 1vh"/>
              </div>
              <div
                  style="display: flex;flex-direction: row;justify-content: space-between;align-items: center;margin-top: 3vh">
                <div style="color: black">M0</div>
                <input v-model="form3.S_M_entry"
                       style="width: 5vw; border:2px #004e9c solid; border-radius: 20px; height: 3vh;margin-top: 1vh"/>
                <div style="color: black">Z0</div>
                <input v-model="form3.s_altitude_entry"
                       style="width: 5vw; border:2px #004e9c solid; border-radius: 20px; height: 3vh;margin-top: 1vh"/>
              </div>
              <div
                  style="display: flex;flex-direction: row;justify-content: space-between;align-items: center;margin-top: 3vh">
                <div style="color: black">M1</div>
                <input v-model="form3.S_M_entry1"
                       style="width: 5vw; border:2px #004e9c solid; border-radius: 20px; height: 3vh;margin-top: 1vh"/>
                <div style="color: black">Z1</div>
                <input v-model="form3.s_altitude_entry1"
                       style="width: 5vw; border:2px #004e9c solid; border-radius: 20px; height: 3vh;margin-top: 1vh"/>
              </div>
              <div
                  style="display: flex;flex-direction: row;justify-content: space-between;align-items: center;margin-top: 3vh">
                <div style="color: black">M2</div>
                <input v-model="form3.S_M_entry2"
                       style="width: 5vw; border:2px #004e9c solid; border-radius: 20px; height: 3vh;margin-top: 1vh"/>
                <div style="color: black">Z2</div>
                <input v-model="form3.s_altitude_entry2"
                       style="width: 5vw; border:2px #004e9c solid; border-radius: 20px; height: 3vh;margin-top: 1vh"/>
              </div>
              <div
                  style="display: flex;flex-direction: row;justify-content: space-between;align-items: center;margin-top: 3vh">
                <div style="color: black">M3</div>
                <input v-model="form3.S_M_entry3"
                       style="width: 5vw; border:2px #004e9c solid; border-radius: 20px; height: 3vh;margin-top: 1vh"/>
                <div style="color: black">Z3</div>
                <input v-model="form3.s_altitude_entry3"
                       style="width: 5vw; border:2px #004e9c solid; border-radius: 20px; height: 3vh;margin-top: 1vh"/>
              </div>
        ...
        <div style="display: flex; flex-direction: row;margin-top: 4%">
          <div style="margin-left: 2vw;width: 30%">
            <el-form :model="form4" style="width: 100%">
              ...
              <div>
                <div style="color: black">范围(km)</div>
                <input v-model="form4.Range"
                       style="width: 14vw; border:2px #004e9c solid; border-radius: 20px; height: 3vh;margin-top: 1vh"/>
              </div>
              <div style="margin-top: 3vh">
                <div style="color: black">M</div>
                <input v-model="form4.name"
                       style="width: 14vw; border:2px #004e9c solid; border-radius: 20px; height: 3vh;margin-top: 1vh"/>
              </div>
              <div
                  style="display: flex;flex-direction: row;justify-content: space-between;align-items: center;margin-top: 3vh">
                <div style="color: black">M0</div>
                <input v-model="form4.e_M_entry"
                       style="width: 5vw; border:2px #004e9c solid; border-radius: 20px; height: 3vh;margin-top: 1vh"/>
                <div style="color: black">Z0</div>
                <input v-model="form4.e_altitude_entry"
                       style="width: 5vw; border:2px #004e9c solid; border-radius: 20px; height: 3vh;margin-top: 1vh"/>
              </div>
              <div
                  style="display: flex;flex-direction: row;justify-content: space-between;align-items: center;margin-top: 3vh">
                <div style="color: black">M1</div>
                <input v-model="form4.e_M_entry1"
                       style="width: 5vw; border:2px #004e9c solid; border-radius: 20px; height: 3vh;margin-top: 1vh"/>
                <div style="color: black">Z1</div>
                <input v-model="form4.e_altitude_entry1"
                       style="width: 5vw; border:2px #004e9c solid; border-radius: 20px; height: 3vh;margin-top: 1vh"/>
              </div>
              <div
                  style="display: flex;flex-direction: row;justify-content: space-between;align-items: center;margin-top: 3vh">
                <div style="color: black">M2</div>
                <input v-model="form4.e_M_entry2"
                       style="width: 5vw; border:2px #004e9c solid; border-radius: 20px; height: 3vh;margin-top: 1vh"/>
                <div style="color: black">Z2</div>
                <input v-model="form4.e_altitude_entry2"
                       style="width: 5vw; border:2px #004e9c solid; border-radius: 20px; height: 3vh;margin-top: 1vh"/>
              </div>
              <div
                  style="display: flex;flex-direction: row;justify-content: space-between;align-items: center;margin-top: 3vh">
                <div style="color: black">M3</div>
                <input v-model="form4.e_M_entry3"
                       style="width: 5vw; border:2px #004e9c solid; border-radius: 20px; height: 3vh;margin-top: 1vh"/>
                <div style="color: black">Z3</div>
                <input v-model="form4.e_altitude_entry3"
                       style="width: 5vw; border:2px #004e9c solid; border-radius: 20px; height: 3vh;margin-top: 1vh"/>
              </div>
      ...
      <el-dialog title="蒸发波导" top="20px" :visible.sync="dialogEvaDVisible" width="70%" class="showInfo1">
        <div style="display: flex; flex-direction: row;margin-left: 5%">
          <div
              style="color: #fff; background-color: #004e9c;border-radius: 20px;width: 7vw; height: 3.7vh;align-items: center;justify-content: center; font-size: 20px;margin-top: -2%">
            <div style="margin-left: 20%;margin-top: 2%">
              蒸发波导
            </div>
          </div>
          <el-button size="small"
                     style="width: 3vw;height:3vh;display: flex;justify-content: center;background-color: #f19149;color: #FFFFFF;margin-top: -1%; margin-left: 65%"
                     @click="DQ2">绘图
          </el-button>
          <el-button size="small" @click="dialogSDVisible = false"
                     style="width: 3vw;height:3vh;display: flex;justify-content: center;background-color: #004e9c;color: #FFFFFF;margin-top: -1%">
        ...
        <div style="display: flex; flex-direction: row;margin-left: 5%;margin-top: 4%">
          <div style="display: flex; flex-direction: column; width: 35%">
            ...
            <div style="display: flex;flex-direction: column; width: 100%;justify-content: start;margin-top: 4%;">
              ...
              <el-form :model="form5" style="margin-top: 1vh">
                ...
                <div>
                  <div style="color: black">范围(km)</div>
                  <input v-model="form5.max_altitude"
                         style="width: 14vw; border:2px #004e9c solid; border-radius: 20px; height: 3vh;margin-top: 1vh"/>
                </div>
              </el-form>
              ...
              <el-form :model="form5" style="margin-top: 1vh">
                <div style="margin-top: 3vh">
                  ...
                  <input disabled v-model="form5.max_altitude"
                         style="width: 14vw; border:2px #004e9c solid; border-radius: 20px; height: 3vh;margin-top: 1vh"/>
                </div>
                <div style="margin-top: 3vh">
                  <div style="color: black">M0</div>
          ...
          <div style="width: 60%">
            <el-card style="background-color: #006cda; border-radius: 20px;">
              <div
                  style="color: #004e9c; background-color: #fff;border-radius: 20px;width: 14vw; height: 3.7vh;align-items: center;justify-content: center; font-size: 20px;margin-top: 0%">
                <div style="margin-left: 20%;margin-top: 2%">
                  使用蒸发波导模型
                </div>
              </div>
                      ...
                      <el-form :model="form5" style="margin-top: 1vh; width: 90%">
                        <div
                          ...
                          <div style="display: flex;flex-direction: row;width: 50% ">
                            ...
                            <input v-model="form5.atmosferikSicaklik"
                                   style="width: 5vw; border:2px #004e9c solid; border-radius: 20px; height: 3vh;margin-top: 1vh"/>
                          ...
                          <div style="display: flex;flex-direction: row;width: 50% ;margin-left: 4vw">
                            ...
                            <input v-model="form5.denizYuzeySicakligi"
                                   style="width: 5vw; border:2px #004e9c solid; border-radius: 20px; height: 3vh;margin-top: 1vh"/>
                            <div style="color: #fff;margin-left: 1vw;width:3vw">C</div>
                          </div>
                        </div>
        ...
        <div style="display: flex; flex-direction: row;height: 30vw; margin-top: 4%">
          <div style="margin-left: 2vw;width: 30%">
            <el-form :model="form6" style="width: 100%">
              ...
              <div style="display: flex;flex-direction: row;justify-content: space-between;align-items: center;">
                <input v-model="form6.M_units[form6.M_units.length - 1]"
                       style="width: 5vw; border:2px #004e9c solid; border-radius: 20px; height: 3vh;margin-top: 1vh"/>
                <input v-model="form6.altitude[form6.altitude.length - 1]"
                       style="width: 5vw; border:2px #004e9c solid; border-radius: 20px; height: 3vh;margin-top: 1vh"/>
              </div>
            ...
            <!--            </el-form>-->
            <div
                style="width: 100%;height: 20%;display: flex;flex-direction: row;justify-content: space-around;border: 1px solid #006cda;border-radius: 20px; margin-top: 2vh">
              <div style="width: 50%;height:100%;">
                <div style="text-align: center;font-size: 1vw;" v-for="(item, index) in list" :key="item"
                     @click="DQ6info(index)">{{ item[0] }}
                </div>
              </div>
              <div style="width: 50%;height:100%;">
                <div style="text-align: center;font-size: 1vw;" v-for="(item, index) in list" :key="item"
                     @click="DQ6info(index)">{{ item[1] }}
                </div>
              </div>
            </div>
...
export default {
  ...
  methods: {
    // 保存单个图表并上传到服务器
    async saveChartToServer(chartDomId, fileName) {
      try {
        const chart = echarts.getInstanceByDom(document.getElementById(chartDomId));
        if (!chart) {
          throw new Error('图表未找到');
        }
        ...
        if (response.data.code === 200) { // 根据你的AjaxResult调整
          console.log(`${fileName} 上传成功:`, response.data);
          return response.data.data.url; // 根据你的返回结构调整
        } else {
    ...
    // 保存地形图
    async saveTerrainChart() {
      try {
        const fileUrl = await this.saveChartToServer('terrainChart', `terrain_${this.jsId}_${Date.now()}.png`);
        this.$message.success('地形图保存成功！');
        return fileUrl;
      } catch (error) {
        this.$message.error('地形图保存失败！');
        return null;
      }
    },

    // 保存热力图
    async saveHeatmapChart() {
      try {
        const fileUrl = await this.saveChartToServer('heatmap-chart', `heatmap_${this.jsId}_${Date.now()}.png`);
        this.$message.success('热力图保存成功！');
        return fileUrl;
      } catch (error) {
        this.$message.error('热力图保存失败！');
        return null;
      }
    },
    ...
    async saveAllCharts() {
      try {
        this.$message.info('开始保存图表...');

        const terrainUrl = await this.saveTerrainChart();
        // 稍微延迟一下，避免同时上传造成服务器压力
        await new Promise(resolve => setTimeout(resolve, 500));

        const heatmapUrl = await this.saveHeatmapChart();

        this.$message.success('所有图表保存完成！');
        ...
        this.$message.error('保存图表过程中发生错误！');
        console.error('保存所有图表失败:', error);
        return {
          terrainUrl: null,
          heatmapUrl: null
        };
    ...
    async save() {
      try {
        // 先保存图表到服务器
        const chartsData = await this.saveAllCharts();
        ...
        // 保存图表URL到数据中
        this.dataFinal1.allImg = `${chartsData.terrainUrl || ''},${chartsData.heatmapUrl || ''}`;

        // 保存到主服务器
        const saveResponse = await this.$axios({
          url: "http://127.0.0.1:10035/save/JsResult",
          method: "post",
