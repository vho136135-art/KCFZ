<template>
  <div class="background-container">
    <div class="content-container">
      <div
          style="display: flex;width: 80%;margin-left: 14vw;margin-bottom: 1.5vh;margin-top: 1.5vh;align-items: center;justify-items: center;justify-content: center;">
        ...
        <el-button type="primary" class="button1" style="height: 1.5vw;margin-left: 1vw;"
