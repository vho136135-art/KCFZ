    ...
    <div class="content-container" id="capture">
      ...
      <div style="width: 94%;display: flex;flex-direction: row;height: 60%;margin-left: 3%;margin-top: 1%;">
        <div class="imgBox" style="display: flex;justify-content: center;">
          <!-- <img :src="src" @click="showBigInfo" style="height: 96%;margin-top: 1%;object-fit: contain;"> -->
      ...
      <div class="canshu">
        ...
        <div style="display: flex;flex-direction: row;">
          <div style="width: 20%;height: 100%;">
            ...
            <div style="width: 100%;height: 3vh;margin-left: 3%;display: flex;flex-direction: row;margin-top: 7%;">
              <div style="width: 50%;line-height: 3vh;color: #Ffffff;font-size: 1vw;margin-left: 10%;">发射仰角(rad)</div>
              <div class="inputbg" style="width: 30%;">
      ...
      <!--      <div style="display: flex;width: 98%;width: 96.5%;height: 87%;flex-direction: column;align-items: center;" class="waibiankuang">-->
      <!--        <div style="display: flex;">-->
      <!--          <div style="display: flex;flex-direction: column;height: 42vh;margin-left: 0.5vw;margin-bottom: 2vh;margin-right: 2vw;"-->
      <!--            class="back">-->
      <!--            <div-->
      <!--              style="display: flex;justify-content: space-between;width: 28vw;margin-bottom: 1.5vh;margin-left: 1vw;margin-top: 1.5vh;"-->
      <!--              class="biaotou">-->
      ...
      <!--                    style="display: flex;align-items: center;width: 0.6vw;margin-left: 1vw;margin-right: 0.4vw;height: 100%;" />-->
      <!--                </div>-->
      <!--                <div style="color: #fff; text-align: left;white-space: nowrap;font-size: 0.9vw;">计算参数设置</div>-->
      <!--              </div>-->
      <!--            </div>-->
      ...
      <!--                  <div class="text">方位角(°)</div>-->
      <!--                  <div class="inputbg">-->
      <!--                    <el-input v-model="form.a" autocomplete="off" @focus="onFocus" @blur="onBlur"></el-input>-->
      <!--                  </div>-->
      <!--                </div>-->
      <!--              </div>-->
      <!--              <div class="formaction">-->
      <!--                <div class="text">发射仰角(°)</div>-->
      <!--                <div class="inputbg">-->
      <!--                  <el-input v-model="form.b" autocomplete="off" @focus="onFocus" @blur="onBlur"></el-input>-->
      <!--                </div>-->
      <!--              </div>-->
      <!--              <div class="formaction">-->
      <!--                <div class="text">发射点经度(°)</div>-->
      <!--                <div class="inputbg">-->
      <!--                  <el-input v-model="form.longtitude" autocomplete="off" @focus="onFocus" @blur="onBlur"></el-input>-->
      <!--                </div>-->
      <!--              </div>-->
      <!--              <div class="formaction">-->
      <!--                <div class="text">发射点纬度(°)</div>-->
      <!--                <div class="inputbg">-->
      <!--                  <el-input v-model="form.latitude" autocomplete="off" @focus="onFocus" @blur="onBlur"></el-input>-->
      <!--                </div>-->
      <!--              </div>-->
      <!--              <div class="formaction">-->
      <!--                <div class="text">工作频率(Hz)</div>-->
      <!--                <div class="inputbg">-->
      <!--                  <el-input v-model="form.fre" autocomplete="off" @focus="onFocus" @blur="onBlur"></el-input>-->
      <!--                </div>-->
      <!--              </div>-->
      <!--              <div class="formaction">-->
      <!--                <div class="text">最大电子密度(10^12/m³)</div>-->
      <!--                <div class="inputbg">-->
      <!--                  <el-input v-model="form.N_m" autocomplete="off" @focus="onFocus" @blur="onBlur"></el-input>-->
      <!--                </div>-->
      <!--              </div>-->
      <!--              <div class="formaction">-->
      <!--                <div class="text">电离层最大高度(km)</div>-->
      <!--                <div class="inputbg">-->
      <!--                  <el-input v-model="form.r_m" autocomplete="off" @focus="onFocus" @blur="onBlur"></el-input>-->
      <!--                </div>-->
      <!--              </div>-->
      <!--              <div class="formaction">-->
      <!--                <div class="text">电离层底部高度(km)</div>-->
      <!--                <div class="inputbg">-->
      <!--                  <el-input v-model="form.r_b" autocomplete="off" @focus="onFocus" @blur="onBlur"></el-input>-->
      <!--                </div>-->
      <!--              </div>-->
      <!--            </div>-->
      <!--          </div>-->
