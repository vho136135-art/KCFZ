    ...
    <div class="content-container">
      ...
      <div style="display: flex;width: 96.5%;height: 87%;flex-direction: column;" class="waibiankuang">
        ...
        <div style="display: flex;flex-direction: row;justify-content: space-around">
          ...
          <div style="width: 37vw;height: 32vw;display: flex;justify-content: space-between;flex-direction: column;">
            <div class="back" style="justify-content:space-around;">
              <div style="display: flex;width: 35vw;margin-bottom: 1vh;margin-left: 1vw;margin-top: 1.5vh;" class="biaotou">
                <div style="vertical-align: middle;align-items: center;">
                  <div style="display: flex;align-items: baseline;height: 100%;width: 100%;position: relative;" class="biaotouqian">
                    <el-image :src="require('@/assets/img/qianbiao.png')"  style="display: inline-block;height: 100%;" />
                    <div style="color: #fff; white-space: nowrap;font-size: 0.9vw;position: absolute;top: 0;display: flex;justify-content: left;justify-items: center;align-items: center;left: 0.5vw;">
                      <div style="height: 0.4vw;width: 0.6vw;border-radius: 2vw;background-color: #FFFFFF;margin-left: 0.1vw;"></div>
                      <div >声呐参数</div>
                    </div>
                  </div>
            ...
            <div class="back" style="justify-content:space-around;height: 9vw;">
              <div style="display: flex;width: 35vw;margin-bottom: 1vh;margin-left: 1vw;margin-top: 1.5vh;" class="biaotou">
                <div style="vertical-align: middle;align-items: center;">
                  <div style="display: flex;align-items: baseline;height: 100%;width: 100%;position: relative;" class="biaotouqian">
                    <el-image :src="require('@/assets/img/qianbiao.png')"  style="display: inline-block;height: 100%;" />
              ...
              <div class="formaction" >
                频率
                <el-input v-model="Frequency" autocomplete="off" @focus="onFocus" @blur="onBlur" style="margin-left: 16vw;"></el-input>
              ...
              <div class="formaction">
                深度
                <el-input v-model="displayValue" autocomplete="off" @focus="onFocus" @blur="onBlur" style="margin-left: 16vw;"></el-input>
            ...
            <div class="back" style="justify-content:space-around;height: 7vw;">
              <div style="display: flex;width: 35vw;margin-bottom: 1vh;margin-left: 1vw;margin-top: 1.5vh;" class="biaotou">
                <div style="vertical-align: middle;align-items: center;">
                  <div style="display: flex;align-items: baseline;height: 100%;width: 100%;position: relative;" class="biaotouqian">
                    <el-image :src="require('@/assets/img/qianbiao.png')"  style="display: inline-block;height: 100%;" />
              ...
              <div class="formaction">
                ...
                <el-input v-model="targetRange" autocomplete="off" @focus="onFocus" @blur="onBlur" readonly="true"
                          style="background-color: gainsboro;color: #fff;margin-left: 12.5vw;"></el-input>
                ...
                <ul v-if="showOption5" class="options" style="margin-left: 12.7vw;height: 5vh;overflow-y: scroll;">
          ...
          <div style="width: 37vw;height: 32vw;display: flex;justify-content: space-between;flex-direction: column;">
            <div class="back" style="justify-content:space-around;height: 20.5vw;" >
              <div style="display: flex;width: 35vw;margin-bottom: 1vh;margin-left: 1vw;margin-top: 1.5vh;" class="biaotou">
                <div style="vertical-align: middle;align-items: center;">
                  <div style="display: flex;align-items: baseline;height: 100%;width: 100%;position: relative;" class="biaotouqian">
                    <el-image :src="require('@/assets/img/qianbiao.png')"  style="display: inline-block;height: 100%;" />
              ...
              <div style="height: 4vw;">
                ...
                <div class="formaction">
                  信噪比(dB)
                  <el-input v-model="displayValue1" autocomplete="off" @focus="onFocus" @blur="onBlur"
                            :readonly="showParams"
                            :style="{ backgroundColor: showParams ? 'gainsboro' : 'transparent' }"></el-input>
                </div>
              </div>
              <div style="background-color: rgba(120,216,255,0.8);width: 100%;height: 2vw;font-size: 0.8vw;text-align: center;color: #FFFFFF;line-height: 2vw;" @click="turnMode">输入参数计算信噪比</div>
              <div style="height: 10vw;padding-top: 1vw;">
            ...
            <div class="back" style="justify-content:space-around;height: 10vw;" >
              <div style="display: flex;width: 35vw;margin-bottom: 1vh;margin-left: 1vw;margin-top: 1.5vh;" class="biaotou">
                <div style="vertical-align: middle;align-items: center;">
                  <div style="display: flex;align-items: baseline;height: 100%;width: 100%;position: relative;" class="biaotouqian">
                    <el-image :src="require('@/assets/img/qianbiao.png')"  style="display: inline-block;height: 100%;" />
              ...
              <!--       这是操作部分的代码       -->
              <div style="width: 100%;height: 20vw;display: flex;flex-direction: row;justify-content: space-around;justify-items: center;align-items: center;margin-left: 4vw;margin-top: 0.6vw;">
                <div style="width: 48%;height: 100%;">
                  <div style="width: 10vw;height: 3vw;text-align: center;padding-left: 2vw;font-size: 1vw;line-height: 2vw;color: #FFFFFF;" class="buttonLeft" @click="test">
                    载入测试值
                  </div>
                  <div style="width: 10vw;height: 3vw;text-align: center;padding-left: 2vw;font-size: 1vw;line-height: 2vw;color: #FFFFFF;" class="buttonLeft" @click="clear">
                    清除数据
                  </div>
                </div>
                <div style="width: 48%;height: 100%">
                  <div style="width: 10vw;height: 3vw;text-align: center;padding-right:2vw;font-size: 1vw;line-height: 2vw;color: #FFFFFF;" class="buttonRight" @click="sumbitInfo">
                    计算
                  </div>

                  <div style="width: 10vw;height: 3vw;text-align: center;padding-right: 2vw;font-size: 1vw;line-height: 2vw;color: #FFFFFF;" class="buttonRight" @click="save">
                    保存
                  </div>
                </div>
...
.back {
  ...
  width: 37vw;
  border-radius: 10px;
  background-color: rgba(39, 131, 223, 0.82);
  /* 拉伸图像以填充整个元素 */
  background-repeat: no-repeat;
}
