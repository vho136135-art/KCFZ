  ...
  <div style="width: 100%;height: 100%;">
    ...
    <div class="content">
      ...
      <div class="rightContent">
        <div
            style="background-color: rgba(255,255,255,1);width: 98.7%;height: 95.5%;position: absolute;z-index: -1;left: 1.2%;top: 4.5%;border-radius: 1vw;">
        </div>
        <!-- 侧边栏开启按钮 -->
        ...
        <div class="showList" v-if="showList">
          <div
            ...
            <el-button type="primary" @click="addGz"
                       style="margin-left: 1vw;width:3vw;height:2vh;display: flex;align-items: center;justify-content: center;margin-right: 1vw;">
              新增规则
            </el-button>
            ...
            <el-button
                ...
                type="primary" @click="openFileInputData">导入规则
            </el-button>
            ...
            <el-button
                ...
                type="primary" @click="exportSql">导出规则
            </el-button>
          </div>
        ...
        <div class="sidebar" :class="{ 'sidebar-visible': sidebarVisible }">
          ...
          <div class="sidebar-content">
            <div class="sidebar-item" v-for="(item, index) in sidebarItems" :key="index"
                 @mouseenter="selectSidebarItem(index)"
                 :class="{ 'sidebar-item-active': selectedSidebarItem === index }">
              {{ item }}
            </div>
        ...
        <div class="contentInfo" style="position: relative;margin-top: 4%;">
          ...
          <div
            ...
            <el-button style="height: 100%;width: 5vw;text-align: center;display:flex;justify-content: center;"
                       type="primary" @click="openDialog">历史检索
            </el-button>
          ...
          <div class="contentBox1">
            <div style="height: 1.8vw;margin-bottom: 1vw;margin-top: 2vh;position: relative;">
              ...
              <div style="font-size: 1vw;margin-left: 4%;line-height: 1.8vw;color: #FFFFFF">任务名称</div>
            </div>
              ...
              <div class="custom-select" @click="toggleOptions1">
                ...
                <div style="width: 20vw;position: relative;">
                  <img src="../assets/img/graphInput.png"
                       style="position: absolute;z-index: -1;width:100%;height: 100%;background-color: rgba(37,139,255,0.73);border-radius: 1vw;">
          ...
          <div class="contentBox2" style="margin-top: 0.5vw;">
            <div style="height: 1.8vw;margin-bottom: 1vw;position: relative;">
              <img src="../assets/img/baogaoDH.png"
                   style="height: 100%;object-fit: contain;position: absolute;z-index: -1;">
              <div style="font-size: 1vw;margin-left: 4%;line-height: 1.8vw;color: #FFFFFF">任务目的</div>
            </div>
            <div
                style="width: 90%;height: 5vw;margin-left: 5%;border-radius: 0.5vw;border: 2px rgba(34,206,255,0.9) solid;background-color: rgba(37,139,255,0.73)">

              <el-input type="textarea" :rows="3" placeholder="请输入任务目的" style="color: #000000;" v-model="rwmd">
              </el-input>
            </div>
          </div>
          <div class="contentBox3" style="margin-top: 0.5vw;">
            <div style="height: 1.8vw;margin-bottom: 1vw;position: relative;">
              <img src="../assets/img/baogaoDH.png"
                   style="height: 100%;object-fit: contain;position: absolute;z-index: -1;">
              <div style="font-size: 1vw;margin-left: 4%;line-height: 1.8vw;color: #FFFFFF">任务时间</div>
            </div>
            <div style="width: 90%;height: 2vw;margin-left: 5%;border-radius: 0.5vw;">
          ...
          <div class="contentBox6">
            <div style="height: 1.8vw;margin-bottom: 1vw;position: relative;">
              <img src="../assets/img/baogaoDH.png"
                   style="height: 100%;object-fit: contain;position: absolute;z-index: -1;">
              <div style="font-size: 1vw;margin-left: 4%;line-height: 1.8vw;color: #FFFFFF">任务海区</div>
            </div>
            <div
                style="width: 90%;height: 5vw;margin-left: 5%;border-radius: 0.5vw;border: 2px rgba(34,206,255,0.9) solid;background-color: rgba(37,139,255,0.73)">
              <el-input type="textarea" :rows="3" placeholder="请输入任务海区" style="color: #000000;" v-model="rwhq">
              </el-input>
            </div>
          </div>
          <div class="contentBox5">
            <div style="height: 1.8vw;margin-bottom: 1vw;position: relative;">
              <img src="../assets/img/baogaoDH.png"
                   style="height: 100%;object-fit: contain;position: absolute;z-index: -1;">
              <div style="font-size: 1vw;margin-left: 4%;line-height: 1.8vw;color: #FFFFFF">任务兵力</div>
            </div>
          ...
          <div class="contentBox4">
            <div style="height: 1.8vw;margin-bottom: 1vw;position: relative;">
              <img src="../assets/img/baogaoDH.png"
                   style="height: 100%;object-fit: contain;position: absolute;z-index: -1;">
              <div style="font-size: 1vw;margin-left: 4%;line-height: 1.8vw;color: #FFFFFF">任务环境</div>
            </div>
          ...
          <div class="contentBox7" style="margin-top: 1vw;">
            <div style="height: 1.8vw;margin-bottom: 1vw;position: relative;">
              <img src="../assets/img/baogaoDH.png"
                   style="height: 100%;object-fit: contain;position: absolute;z-index: -1;">
              <div style="font-size: 1vw;margin-left: 4%;line-height: 1.8vw;color: #FFFFFF">环境分析</div>
            </div>
            ...
            <div style="width: 90%;margin-left: 5%;" class="testInfo">
              <editor v-model="txzhys" :config="editorConfig3" placeholder="请输入环境对通信载荷的影响"
                      :disabled="true"/>
            ...
            <div style="width: 90%;margin-left: 5%;" class="testInfo" v-if="showGJZH()">
              <editor v-model="gjzhys" :config="editorConfig5" placeholder="请输入环境对攻击载荷的影响"
                      :disabled="true"/>
    ...
    <el-dialog title="添加规则" :visible.sync="showGz" style="width: 60% !important;margin-left: 20%;" class="dialog1">
      ...
      <el-select v-model="gzInfoType" placeholder="请选择一级分类"
                 style="margin-bottom: 2vh;display: block;width: 11.5vw;"
                 class="selectPlace">
        <el-option v-for="item in yjgzTypeList" :key="item.id" :label="item.label" :value="item.value"/>
      </el-select>
      <el-select v-model="gzInfoType1" placeholder="请选择二级分类"
                 style="margin-bottom: 2vh;display: block;width: 11.5vw;"
                 class="selectPlace">
    ...
    <el-dialog title="报告名称" :visible.sync="dialogVisibleInput" width="30%">
      <div style="height: 100%;" class="divBg">
        <el-input v-model="baoGaoName" placeholder="请输入报告名称"
                  style="margin-bottom: 1vw;width: 30%;margin-left: 1%;margin-top: 2%;"
    ...
    <el-dialog class="history" title="历史检索" :visible.sync="dialogVisibleList" width="50%" label-position="left">
      <el-select v-model="task" placeholder="请选择任务" class="head" style="margin-top: 5vh;">
      ...
      <el-input class="input" v-model="dqnjd" placeholder="请输入能见度" style="margin-left: 0.9vw;"></el-input>
      ...
      <el-input class="input" v-model="dqhk" placeholder="请输入海况" style="margin-left: 0.9vw;"></el-input>
    ...
    <el-dialog title="计算结果列表" :visible.sync="dialogVisibleJs" width="80%">
      ...
      <el-table class="jsJG" ref="myTable" :data="tableDataListJs" v-if="jsKey == 'QJFXT'">
      ...
      <el-table ref="myTableTx1" :data="tableDataListJs" v-if="jsKey == 'DBDLC'">
        ...
        <el-table-column prop="b_min" label="发射仰角" header-align="center" align="center">
          <template slot-scope="scope">
            {{scope.row.b_min}}~{{scope.row.b_max}}
          </template>
        </el-table-column>
      ...
      <el-table ref="myTableTc1" :data="tableDataListJs" v-if="jsKey == 'LDWLT'">
        <el-table-column prop="max_range" label="最大距离" header-align="center" align="center">
        </el-table-column>
        <el-table-column prop="max_altitude" label="最大高度" header-align="center" align="center">
        </el-table-column>
        <el-table-column prop="range_step" label="距离步长" header-align="center" align="center">
        </el-table-column>
        <el-table-column prop="altitude_step" label="高度步长" header-align="center" align="center">
        </el-table-column>
        <el-table-column prop="analysis_type" label="分析类型" header-align="center" align="center">
        </el-table-column>
        <el-table-column prop="polarization" label="极化" header-align="center" align="center">
        </el-table-column>
        <el-table-column prop="beamwidth" label="3dB波束宽度" header-align="center" align="center">
        </el-table-column>
        <el-table-column prop="elevation_angle" label="仰角" header-align="center" align="center">
        </el-table-column>
        <el-table-column prop="antenna_height" label="天线高度" header-align="center" align="center">
        </el-table-column>
        <el-table-column prop="frequency" label="频率" header-align="center" align="center">
        </el-table-column>
        <el-table-column prop="surface_type" label="表面类型" header-align="center" align="center">
        </el-table-column>
        <el-table-column prop="surface_type_combobox" label="介质类型" header-align="center" align="center">
        </el-table-column>
        <el-table-column prop="dielectric_constant" label="介电常数" header-align="center" align="center">
        </el-table-column>
        <el-table-column prop="conductivity" label="电导率" header-align="center" align="center">
        </el-table-column>
        <el-table-column prop="refractivity_type" label="折射率类型" header-align="center" align="center">
        </el-table-column>

        <el-table-column prop="refractivity_type_combobox" label="波导类型" header-align="center" align="center">
        </el-table-column>
        <el-table-column prop="Range" label="范围" header-align="center" align="center">
        </el-table-column>
        <el-table-column prop="Profile" label="剖面" header-align="center" align="center">
        </el-table-column>
        <el-table-column prop="num_points" label="点数" header-align="center" align="center">
        </el-table-column>
        <el-table-column prop="terrain_type" label="地形类型" header-align="center" align="center">
        </el-table-column>
        <el-table-column prop="interpolation_type" label="插值类型" header-align="center" align="center">
        </el-table-column>
        <el-table-column prop="tRange" label="地形范围" header-align="center" align="center">
        </el-table-column>
        <el-table-column prop="Height" label="地形高度" header-align="center" align="center">
        </el-table-column>
        <el-table-column prop="createTime" label="创建时间" header-align="center" align="center">
        </el-table-column>
        <el-table-column prop="allImg" label="地形图片" width="200" header-align="center" align="center">
          <template slot-scope="scope">
            <el-image style="width: 80px; height: 80px" :src="scope.row.allImg.split(',')[0]" :preview-src-list="[scope.row.allImg.split(',')[0]]"
                      fit="cover" hide-on-click-modal></el-image>
            <!--            <img-->
            <!--                style="width: 100px; height: 100px"-->
            <!--                :src="scope.row.allImg" />-->
        ...
        <el-table-column prop="allImg" label="威力图图片" width="200" header-align="center" align="center">
          <template slot-scope="scope">
            <el-image style="width: 80px; height: 80px" :src="scope.row.allImg.split(',')[1]" :preview-src-list="[scope.row.allImg.split(',')[1]]"
                      fit="cover" hide-on-click-modal></el-image>
            <!--            <img-->
            <!--                style="width: 100px; height: 100px"-->
            <!--                :src="scope.row.allImg" />-->
    ...
    <!--    -->
    <el-dialog title="海洋环境对声呐探测的影响分析软件" :visible.sync="showSN1Js" width="80%" style="height: 100%;">
      <SN1 :jsId="jsId"></SN1>
    </el-dialog>
    ...
    <el-dialog title="大气波导对电磁场传播的影响分析软件" :visible.sync="showLDJS" width="85%">
  ...
  methods: {
    ...
    selectOption3(option) {
      ...
      if (this.rwmc.text == "对潜搜索") {
        if (this.fjxh.text == "F" || this.fjxh.text == "G") {
          this.options5 = [{
            value: '机载雷达',
            label: '机载雷达'
          },
    ...
    searchTuPu() {
      if (this.rwmc.text != "请选择任务" && this.rwmc.text != undefined) {
        ...
        if(this.form1.type = "对海攻击(反舰)"){
          this.form1.type = "对海攻击"
        }
      } else {
        this.form1.type = ""
      }
      ...
      getDomainGraphNew1(this.form1).then((res) => {
        ...
        const DQJSNode = nodes.filter(n => n.jsInfo === "DQJS");
        if (DQJSNode.length > 0) {
          for (let i = 0; i < DQJSNode.length; i++) {
            let name = DQJSNode[i].name;
            this.tcjslist.push({name: name})
          }
        }
    ...
    getAllJs() {
      ...
      getAllJsResult(data).then((res) => {
        if (res.data) {
          ...
          console.log(this.tableDataListJs)
          // if(res.data.useZjsb){
    ...
    useInfo(row) {
      ...
      if (this.jsKey == "DBDLC") {
        ...
        // .join(", ");
        console.log(result111)
        this.txzhysImg = result111[6].split("图片：")[1];
        delete result111[6];
        if (this.txzhys == "<p>请输入环境对通信载荷的影响</p>") {
    ...
    historyJs(row) {
      ...
      this.jsKey = "";
      this.jsType = undefined
      if (row.name == "XXXX辅助决策" || row.name == "起降风限图") {
        this.changeJsType("QJFXT");
      }
      if (row.name == "电离层对短波通信的影响分析软件" || row.name == "电离层对短波通信的影响软件") {
      ...
      if (row.name == "大气环境对雷达探测的影响分析软件" || row.name == "大气降水对雷达探测的影响分析软件") {
        this.changeJsType("DQJS")
      }
      if (row.name == "舰载直升机空舰导弹作战使用辅助决策软件" || row.name == "舰载直升机空舰导弹导弹作战使用辅助决策") {
        this.changeJsType("DDZZSYFZJC")
      }
      if (row.name == "舰载直升机航空鱼雷作战使用辅助决策软件" || row.name == "舰载直升机航空鱼雷作战使用辅助决策") {
        this.changeJsType("YLDQGJ")
      }
      if (row.name == "面向舰机超短波通信的表面波导可用性评估软件" || row.name == "超短波") {
    ...
    // 新增方法：同步所有编辑器内容
    syncAllEditorsContent() {
      // 通过DOM获取所有编辑器的内容
      const editorElements = document.querySelectorAll('.w-e-text-container');
      ...
      editorElements.forEach((element, index) => {
        ...
        switch (index) {
          case 0: // 起降环境因素
            this.zzhjys = html;
            this.zzhjys1 = this.extractTextFromHtml(html);
            break;
          case 1: // 飞行作战环境因素
            this.fxhjys = html;
            this.fxhjys1 = this.extractTextFromHtml(html);
            break;
          case 2: // 通信载荷影响
            this.txzhys = html;
            this.txzhys1 = this.extractTextFromHtml(html);
            break;
          case 3: // 探测载荷影响
            this.tczhys = html;
            this.tczhys1 = this.extractTextFromHtml(html);
            break;
          case 4: // 攻击载荷影响
            if (this.showGJZH()) {
              this.gjzhys = html;
              this.gjzhys1 = this.extractTextFromHtml(html);
            }
            break;
        }
      });
    ...
    lookInfo(row) {
      ...
      console.log(jsonObj)
      this.rwmc.text = jsonObj.textData.taskName;
      this.rwmd = jsonObj.textData.taskTarget;
      this.rwsj = jsonObj.textData.taskTime;
      this.rwhq = jsonObj.textData.haiqv;
      this.jtxh.text = jsonObj.textData.jtxh;
      this.fjxh.text = jsonObj.textData.fjxh;
      // this.rwhj[0].firstRow = jsonObj.tableData[0].rows[0][0];
      // console.log(jsonObj.tableData[0].rows[0][0])
      // this.rwhj[0].secondRow = jsonObj.tableData[0].rows[0][1];
      // console.log(jsonObj.tableData[0].rows[0][1])
      ...
      this.txzh.text = jsonObj.textData.txzh;
      this.tczh.text = jsonObj.textData.tczh;
      this.gjzh.text = jsonObj.textData.gjzh;

      if (jsonObj.tableData && jsonObj.tableData.length > 0) {
        const taskEnvTable = jsonObj.tableData[0]; // 第一个表格是任务环境

        // 加载 dynamicColumns 和 dynamicColumns1 的数据
        if (taskEnvTable.rows && taskEnvTable.rows.length > 0) {
          const rowsData = taskEnvTable.rows[0]; // 第一个行数组

          if (rowsData && rowsData.length >= 2) {
            // 第一行数据对应 dynamicColumns
            const firstRowData = rowsData[0];
            if (firstRowData && typeof firstRowData === 'object') {
              this.rwhj[0].firstRow = {
                name: firstRowData.name ?? '',
                no: firstRowData.no ?? '',
                bz: firstRowData.bz ?? '',
                fx: firstRowData.fx ?? '',
                fs: firstRowData.fs ?? '',
                njd: firstRowData.njd ?? '',
                yg: firstRowData.yg ?? ''
              };
            }

            // 第二行数据对应 dynamicColumns1 - 修复 0 值问题
            const secondRowData = rowsData[1];
            if (secondRowData && typeof secondRowData === 'object') {
              this.rwhj[0].secondRow = {
                dqwd: secondRowData.dqwd !== undefined ? secondRowData.dqwd : '',
                jsl: secondRowData.jsl !== undefined ? secondRowData.jsl : '',
                dqbd: secondRowData.dqbd !== undefined ? secondRowData.dqbd : '',
                hk: secondRowData.hk !== undefined ? secondRowData.hk : '',
                lx: secondRowData.lx !== undefined ? secondRowData.lx : '',
                ls: secondRowData.ls !== undefined ? secondRowData.ls : '',
                hs: secondRowData.hs !== undefined ? secondRowData.hs : ''
              };
            }

            console.log('加载后的第二行数据:', this.rwhj[0].secondRow);
          }
        }
      ...
      // this.jtbl = [];
      // for (let v = 0; v < jsonObj.tableData[0].rows[0][0].length; v++) {
      //   let jtdata = {
      //     xvhao: jsonObj.tableData[0].rows[0][0][v],
      //     lx: jsonObj.tableData[0].rows[0][0][v],
      //     xinghao: jsonObj.tableData[0].rows[0][0][v],
      //     xjh: jsonObj.tableData[0].rows[0][0][v],
      //     ms: jsonObj.tableData[0].rows[0][0][v],
      //     bz: jsonObj.tableData[0].rows[0][0][v],
      //   }
      ...
      // this.zsjbl = [];
      // for (let v = 0; v < jsonObj.tableData[0].rows[0][1].length; v++) {
      //   let jtdata1 = {
      //     xvhao: jsonObj.tableData[2].rows[0][1][v],
      //     lx: jsonObj.tableData[2].rows[0][1][v],
      //     xh: jsonObj.tableData[2].rows[0][1][v],
      //     xjh: jsonObj.tableData[2].rows[0][1][v],
      //     ms: jsonObj.tableData[2].rows[0][1][v],
      //     bz: jsonObj.tableData[2].rows[0][1][v],
      //   }
    ...
    useJs(row) {
      ...
      if (row.name == "XXXX辅助决策") {
        data.jsInfo = "QJFXT"
      } else if (row.name == "大气降水对雷达探测的影响分析软件" || row.name == "大气降水" ) {
        data.jsInfo = "DQJS"
...
.contentInfo::v-deep(.el-table__header .el-table tr) {
  background-color: rgba(0, 25, 140, 0.58) !important;
}

.contentInfo::v-deep(.el-table tr) {
  background-color: rgba(37, 139, 255, 0.73);
  font-size: 0.8vw;
}
...
.contentInfo::v-deep(.el-table__header) {
  background-color: rgba(0, 25, 140, 0.58);
  border-radius: 2vw;
  font-size: 0.9vw;
}
...
.contentBox3::v-deep(.el-input__inner) {
  background-color: rgba(37, 139, 255, 0.73) !important;
  border: 2px rgba(34, 206, 255, 0.9) solid;
...
.history /deep/ .el-dialog__header {
  background-color: rgba(0, 108, 218, 0.9);
}
