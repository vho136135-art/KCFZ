<template>
  <div class="background-container">
    <div class="content-container">
      <div
          style="display: flex;width: 100%;align-items: center;justify-items: center;justify-content: center;">
      ...
      <div style="width: 100%;height: 90%;margin-top: 1%;display: flex;flex-direction: row;">
        <div class="box1">
          <div style="height: 35%;width: 100%;background-color: #006cda;border-radius: 1vw;">
            ...
            <div style="width: 94%;margin-left: 3%;display: flex;flex-direction: row;margin-top: 1%;">
              <div class="terrain-table" style="margin-left: 14%;height: 4vw;">
                  ...
                  <table v-if="this.form.SeaDep == '浅海'">
                    ...
                    <tr v-for="(item, index) in snTable1" :key="index">
                      <td class="leftTd" style="width: 8vw;">
                        <el-input style="width: 8vw;" type="text" v-model="snTable1[index]" />
                      </td>
          ...
          <div style="height: 35%;width: 100%;background-color: #006cda;border-radius: 1vw;">
            ...
            <div style="width: 94%;height: 2vw;margin-left: 3%;display: flex;flex-direction: row;margin-top: 2%;">
              <div style="width: 50%;line-height: 2vw;color: #Ffffff;font-size: 1vw;margin-left: 10%;">距离上的初始最大值/m</div>
              <div class="inputbg" style="width: 30%;">
                <el-input v-model="form.r2" autocomplete="off" @focus="onFocus" @blur="onBlur"></el-input>
              </div>
            </div>
            <div style="width: 94%;height: 2vw;margin-left: 3%;display: flex;flex-direction: row;margin-top: 2%;">
              <div style="width: 50%;line-height: 2vw;color: #Ffffff;font-size: 1vw;margin-left: 10%;">距离上的间隔/m</div>
              <div class="inputbg" style="width: 30%;">
                <el-input v-model="form.delta_r" autocomplete="off" @focus="onFocus" @blur="onBlur"></el-input>
              </div>
            </div>
            <div style="width: 94%;height: 2vw;margin-left: 3%;display: flex;flex-direction: row;margin-top: 2%;">
              <div style="width: 50%;line-height: 2vw;color: #Ffffff;font-size: 1vw;margin-left: 10%;">接收器深度点数</div>
              <div class="inputbg" style="width: 30%;">
                <el-input v-model="form.Nrd" autocomplete="off" @focus="onFocus" @blur="onBlur"></el-input>
              </div>
            </div>
            <div style="width: 94%;height: 2vw;margin-left: 3%;display: flex;flex-direction: row;margin-top: 2%;">
              <div style="width: 50%;line-height: 2vw;color: #Ffffff;font-size: 1vw;margin-left: 10%;">深度的间隔/m</div>
              <div class="inputbg" style="width: 30%;">
        ...
        <div class="box2">
          <div style="display: flex;flex-direction: row;justify-content: space-between;height: 55%;">
            <div style="height: 100%;width: 30%;background-color: #006cda;border-radius: 1vw;">
              ...
              <div style="width: 94%;height: 2vw;margin-left: 3%;display: flex;flex-direction: row;margin-top: 4%;">
                  ...
                  <div class="tabnle" style="height: 100%;">
                    <table v-if="this.form.SeaDep == '浅海'">
                      ...
                      <tr v-for="(item, index) in diTable1" :key="index">
                        ...
                        <td class="rightTd">
                          <el-input type="text" v-model="diTable2[index]" />
                        </td>
                      </tr>
                      </tbody>
                    </table>
            ...
            <div style="height: 100%;width: 30%;">
              ...
              <div style="height: 30%;width: 100%;margin-top: 6%;background-color: #006cda;border-radius: 1vw;">
                <div
                    style="width: 99%;background-color: #004e9c;height: 2vw;border-radius: 0.6vw;margin-left: 0.5%;text-align: center;color: #Ffffff;line-height: 2vw;font-size: 1vw;margin-top: 1%;">
                  目标强度
                </div>
          ...
          <div class="box3"
               style="display: flex;flex-direction: row;justify-content: space-between;margin-top: 3%;height: 41%">
            <div
      ...
      <!--      <div style="display: flex;width: 98%;width: 96.5%;height: 87%;" class="waibiankuang">-->
      <!--        <div style="display: flex;flex-wrap: wrap;">-->
      <!--          <div style="display: flex;flex-direction: column;">-->
      <!--            <div-->
      <!--                style="display: flex;flex-direction: column;margin-left: 0.5vw;margin-bottom: 2vh;margin-right: 1.5vw;width: 28vw;height: 35vh;"-->
      <!--                class="back">-->
      <!--              <div-->
      <!--                  style="display: flex;justify-content: space-between;width: 26vw;margin-bottom: 2vh;margin-left: 1vw;margin-top: 1vh;"-->
      <!--                  class="biaotou">-->
      ...
      <!--                  </div>-->
      <!--                  <div style="color: #fff; text-align: left;white-space: nowrap;font-size: 1vw;">声速剖面参数设置</div>-->
      <!--                </div>-->
      <!--              </div>-->
      <!--              <div>-->
      <!--                <div class="formaction">-->
      <!--                  <div class="text">深度的间隔/m</div>-->
      <!--                  <div class="inputbg">-->
      <!--                    <el-input v-model="form.delta_depth" autocomplete="off" @focus="onFocus" @blur="onBlur"></el-input>-->
      <!--                  </div>-->
      <!--                </div>-->

      <!--                &lt;!&ndash;                <div class="formaction">&ndash;&gt;-->
      <!--                &lt;!&ndash;                  <div class="text">跃层之下的开始深度</div>&ndash;&gt;-->
      <!--                &lt;!&ndash;                  <div class="inputbg">&ndash;&gt;-->
      <!--                &lt;!&ndash;                    <el-input v-model="form.z2" autocomplete="off" @focus="onFocus" @blur="onBlur"></el-input>&ndash;&gt;-->
      <!--                &lt;!&ndash;                  </div>&ndash;&gt;-->
      <!--                &lt;!&ndash;                </div>&ndash;&gt;-->
      <!--                &lt;!&ndash;                <div class="formaction">&ndash;&gt;-->
      <!--                &lt;!&ndash;                  <div class="text">跃层以上的声速值</div>&ndash;&gt;-->
      <!--                &lt;!&ndash;                  <div class="inputbg">&ndash;&gt;-->
      <!--                &lt;!&ndash;                    <el-input v-model="form.c1" autocomplete="off" @focus="onFocus" @blur="onBlur"></el-input>&ndash;&gt;-->
      <!--                &lt;!&ndash;                  </div>&ndash;&gt;-->
      <!--                &lt;!&ndash;                </div>&ndash;&gt;-->
      <!--                &lt;!&ndash;                <div class="formaction">&ndash;&gt;-->
      <!--                &lt;!&ndash;                  <div class="text">跃层以下的声速值</div>&ndash;&gt;-->
      <!--                &lt;!&ndash;                  <div class="inputbg">&ndash;&gt;-->
      <!--                &lt;!&ndash;                    <el-input v-model="form.c2" autocomplete="off" @focus="onFocus" @blur="onBlur"></el-input>&ndash;&gt;-->
      <!--                &lt;!&ndash;                  </div>&ndash;&gt;-->
      <!--                &lt;!&ndash;                </div>&ndash;&gt;-->

      <!--                <div class="formaction">-->
      <!--                  <div class="text">距离上的初始最大值/m</div>-->
      <!--                  <div class="inputbg">-->
      <!--                    <el-input v-model="form.r2" autocomplete="off" @focus="onFocus" @blur="onBlur"></el-input>-->
      <!--                  </div>-->
      <!--                </div>-->
      <!--                <div class="formaction">-->
      <!--                  <div class="text">距离上的间隔/m</div>-->
      <!--                  <div class="inputbg">-->
      <!--                    <el-input v-model="form.delta_r" autocomplete="off" @focus="onFocus" @blur="onBlur"></el-input>-->
      <!--                  </div>-->
      <!--                </div>-->
      <!--                <div class="formaction">-->
      <!--                  <div class="text">接收器深度点数</div>-->
      <!--                  <div class="inputbg">-->
      <!--                    <el-input v-model="form.Nrd" autocomplete="off" @focus="onFocus" @blur="onBlur"></el-input>-->
      <!--                  </div>-->
      <!--                </div>-->
      <!--                <div class="formaction">-->
      <!--                  <div class="text">固定接收器距离点数</div>-->
      <!--                  <div class="inputbg">-->
      <!--                    <el-input v-model="form.Nrr" autocomplete="off" @focus="onFocus" @blur="onBlur"></el-input>-->
      <!--                  </div>-->
      <!--                </div>-->
      <!--                <div class="formaction">-->
      <!--                  <div class="text">固定点数</div>-->
      <!--                  <div class="inputbg">-->
      <!--                    <el-input v-model="form.num_points" autocomplete="off" @focus="onFocus" @blur="onBlur"></el-input>-->
      <!--                  </div>-->
      <!--                </div>-->
      ...
      <!--              <div-->
      <!--                  style="width: 28vw;margin-right: 1.5vw;margin-left: 0.5vw;border-radius: 1vw;display: flex;height: 31vh;flex-direction: column;"-->
      <!--                  class="back3">-->
      <!--                <div-->
      <!--                    style="display: flex;justify-content: space-between;width: 26vw;margin-bottom: 2vh;margin-left: 1vw;margin-top: 1vh;"-->
      <!--                    class="biaotou">-->
      ...
      <!--                                style="display: inline-block;width: 0.6vw;margin-left: 1vw;margin-right: 0.4vw;height: 100%;"/>-->
      <!--                    </div>-->
      <!--                    <div style="color: #fff; text-align: left;white-space: nowrap;font-size: 1vw;">-->
      <!--                      声源参数与Beam参数设置-->
      <!--                    </div>-->
      <!--                  </div>-->
      <!--                </div>-->
      <!--                <div class="formaction">-->
      <!--                  <div class="text">声源频率/Hz</div>-->
      <!--                  <div class="inputbg">-->
      <!--                    <el-input v-model="form.freq" autocomplete="off" @focus="onFocus" @blur="onBlur"></el-input>-->
      <!--                  </div>-->
      <!--                </div>-->
      <!--                <div class="formaction">-->
      <!--                  <div class="text">声源深度</div>-->
      <!--                  <div class="inputbg">-->
      <!--                    <el-input v-model="form.Pos_s_depth" autocomplete="off" @focus="onFocus" @blur="onBlur"></el-input>-->
      <!--                  </div>-->
      <!--                </div>-->
      <!--                <div class="formaction">-->
      <!--                  <div class="text">声线数目</div>-->
      <!--                  <div class="inputbg">-->
      <!--                    <el-input v-model="form.Beam_Nbeams" autocomplete="off" @focus="onFocus" @blur="onBlur"></el-input>-->
      <!--                  </div>-->
      <!--                </div>-->
      <!--                <div class="formaction">-->
      <!--                  <div class="text">波束张开角度</div>-->
      <!--                  <div class="inputbg">-->
      <!--                    <el-input v-model="form.alpha" autocomplete="off" @focus="onFocus" @blur="onBlur"></el-input>-->
      <!--                  </div>-->
      <!--                </div>-->
      <!--                <div class="formaction">-->
      <!--                  <div class="text">底部声速</div>-->
      <!--                  <div class="inputbg">-->
      <!--                    <el-input v-model="form.Bdry_Bot_cp" autocomplete="off" @focus="onFocus" @blur="onBlur"></el-input>-->
      <!--                  </div>-->
      <!--                </div>-->
      <!--                <div class="formaction">-->
      <!--                  <div class="text">底部密度</div>-->
      <!--                  <div class="inputbg">-->
      <!--                    <el-input v-model="form.Bdry_Bot_rho" autocomplete="off" @focus="onFocus" @blur="onBlur"></el-input>-->
      <!--                  </div>-->
      <!--                </div>-->
      <!--                <div class="formaction">-->
      <!--                  <div class="text">底部衰减</div>-->
      <!--                  <div class="inputbg">-->
      <!--                    <el-input v-model="form.Bdry_Bot_rholns" autocomplete="off" @focus="onFocus"-->
      <!--                              @blur="onBlur"></el-input>-->
      <!--                  </div>-->
      <!--                </div>-->
      <!--                <div class="formaction">-->
      <!--                  <div class="text">海底s波速度</div>-->
      <!--                  <div class="inputbg">-->
      <!--                    <el-input v-model="form.Bdry_Bot_cs" autocomplete="off" @focus="onFocus"-->
      <!--                              @blur="onBlur"></el-input>-->
      <!--                  </div>-->
      <!--                </div>-->
      ...
      <!--                <div style="display: flex;flex-direction: column;width: 28vw;margin-right: 1.5vw;height: 40vh;"-->
      <!--                     class="back2">-->
      <!--                  <div-->
      <!--                      style="display: flex;justify-content: space-between;width: 26vw;margin-bottom: 2vh;margin-left: 1vw;margin-top: 1vh;"-->
      <!--                      class="biaotou">-->
      ...
      <!--                                  style="display: inline-block;width: 0.6vw;margin-left: 1vw;margin-right: 0.4vw;height: 100%;"/>-->
      <!--                      </div>-->
      <!--                      <div style="color: #fff; text-align: left;white-space: nowrap;font-size: 1vw;">吊放声呐参数设置-->
      <!--                      </div>-->
      <!--                    </div>-->
      <!--                  </div>-->
      <!--                  <div class="formaction">-->
      <!--                    <div class="text">声呐发射声源级/dB</div>-->
      <!--                    <div class="inputbg">-->
      <!--                      <el-input v-model="form.SL" autocomplete="off" @focus="onFocus" @blur="onBlur"></el-input>-->
      <!--                    </div>-->
      <!--                  </div>-->
      <!--                  <div class="formaction">-->
      <!--                    <div class="text">接收带宽/HZ</div>-->
      <!--                    <div class="inputbg">-->
      <!--                      <el-input v-model="form.B" autocomplete="off" @focus="onFocus" @blur="onBlur"></el-input>-->
      <!--                    </div>-->
      <!--                  </div>-->
      <!--                  <div class="formaction">-->
      <!--                    <div class="text">积分时间</div>-->
      <!--                    <div class="inputbg">-->
      <!--                      <el-input v-model="form.TT" autocomplete="off" @focus="onFocus" @blur="onBlur"></el-input>-->
      <!--                    </div>-->
      <!--                  </div>-->
      <!--                  <div class="formaction">-->
      <!--                    <div class="text">接收指向性指数</div>-->
      <!--                    <div class="inputbg">-->
      <!--                      <el-input v-model="form.DI" autocomplete="off" @focus="onFocus" @blur="onBlur"></el-input>-->
      <!--                    </div>-->
      <!--                  </div>-->
      <!--                  <div class="formaction">-->
      <!--                    <div class="text">目标强度</div>-->
      <!--                    <div class="inputbg">-->
      <!--                      <el-input v-model="form.TS_alpha" autocomplete="off" @focus="onFocus" @blur="onBlur"></el-input>-->
      <!--                    </div>-->
      <!--                  </div>-->
      ...
      <!--                  <div v-if="this.form.SeaDep=='浅海'" class="allTable"-->
      <!--                       style="width: 90%;display: flex;flex-direction: row;justify-content: space-around;margin-left: 5%">-->
      <!--                    <div class="terrain-table">-->
      <!--                      <div style="width: 100%;text-align: center;color: #FFFFFF">地形</div>-->
      <!--                      <div class="tabnle">-->
      <!--                        <table>-->
      <!--                          <tbody>-->
      <!--                          <tr v-for="(item, index) in diTable1" :key="index">-->
      ...
      <!--                    </div>-->
      <!--                    <div class="terrain-table">-->
      <!--                      <div style="width: 100%;text-align: center;color: #FFFFFF">声速剖面</div>-->
      <!--                      <div class="tabnle">-->
      <!--                        <table>-->
      <!--                          <tbody>-->
      <!--                          <tr v-for="(item, index) in snTable1" :key="index">-->
      <!--                            <td class="leftTd">-->
      <!--                              <el-input type="text" v-model="snTable1[index]"/>-->
      <!--                            </td>-->
      <!--                            <td class="rightTd">-->
      <!--                              <el-input type="text" v-model="snTable2[index]"/>-->
      <!--                            </td>-->
      <!--                          </tr>-->
      <!--                          </tbody>-->
      <!--                        </table>-->
      ...
      <!--                    </div>-->
      <!--                  </div>-->
      <!--                  <div v-if="this.form.SeaDep=='深海'" class="allTable"-->
      <!--                       style="width: 90%;display: flex;flex-direction: row;justify-content: space-around;margin-left: 5%">-->
      <!--                    <div class="terrain-table">-->
      <!--                      <div style="width: 100%;text-align: center;color: #FFFFFF">地形</div>-->
      <!--                      <div class="tabnle">-->
      ...
      <!--                          <tr v-for="(item, index) in snTable1ss" :key="index">-->
      <!--                            <td class="leftTd">-->
      <!--                              <el-input type="text" v-model="snTable1ss[index]"/>-->
      <!--                            </td>-->
      <!--                            <td class="rightTd">-->
      <!--                              <el-input type="text" v-model="snTable2ss[index]"/>-->
      <!--                            </td>-->
      <!--                          </tr>-->
      <!--                          </tbody>-->
      <!--                        </table>-->
      ...
      <!--                </div>-->
      <!--              </div>-->
      <!--              <div style="display: flex;flex-direction: column;width: 17vw;">-->
      <!--                <div class="back1"-->
      <!--                     style="width: 16vw;height: 40vh;margin-left: 0.5vw;display: flex;flex-direction: column;">-->
      <!--                  <div-->
      <!--                      style="display: flex;justify-content: space-between;width: 14vw;margin-bottom: 1vh;margin-left: 1vw;margin-top: 1vh;"-->
      <!--                      class="biaotou">-->
      <!--                    <div style="vertical-align: middle;align-items: center;display: flex;">-->
      <!--                      <div style="display: flex;align-items: baseline;height: 100%;" class="biaotouqian">-->
      <!--                        <el-image :src="require('@/assets/img/qianbiao.png')"-->
      <!--                                  style="display: inline-block;width: 0.6vw;margin-left: 1vw;margin-right: 0.4vw;height: 100%;"/>-->
      <!--                      </div>-->
      <!--                      <div style="color: #fff; text-align: left;white-space: nowrap;font-size: 1.2vw;">仿真控制</div>-->
      <!--                    </div>-->
      <!--                  </div>-->
      ...
      <!--              </div>-->
      <!--            </div>-->
      <!--            <div style="display: flex;width: 22vw;">-->
      <!--              <div style="display: flex;margin-right: 2vw;">-->
      <!--                <div style="width: 22vw; height: 26vh;" class="back4" @click="showBigInfo(src)">-->
      <!--                  <el-image :src="src" style="width: 22vw; height: 26vh;"></el-image>-->
      <!--                </div>-->
      <!--              </div>-->
      <!--              <div style="display: flex;">-->
      <!--                <div style="width: 22vw; height: 26vh;" class="back4" @click="showBigInfo(src1)">-->
      <!--                  <el-image :src="src1" style="width: 22vw; height: 26vh;"></el-image>-->
      <!--                </div>-->
      <!--              </div>-->
      <!--            </div>-->
      <!--          </div>-->
  ...
  methods: {
    ...
    submitForm() {
      ...
      var dataFinal = {
        ...
        "sspm1": this.sspmText1,
        "sspm2": this.sspmText2,
        "Nrd": this.form.Nrd,
        "Nrr": this.form.Nrr,
