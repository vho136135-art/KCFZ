<template>
  <div style="width: 100%;height: 100%;">
    ...
    <div class="content">
      ...
      <div
        style="color: #ffffff; width: 78%;height:8vh;position: absolute;z-index: 1000;left: 12vw;top: 11vh;display: flex;flex-direction: row;justify-content: space-around;">
        <div class="graphcontains1" style="width: 15vw">
          <div
            ...
            <div style="width:10vw;height: 1.7vw;position: relative;">
              ...
              <div style="width: 10%;height: 0.8vw;position: absolute;right: 0.5vw;z-index: 5555;top: 0.3vw;"
                @click="getInfo1()">
                <img src="../assets/img/look.png" style="width: 100%;height: 100%;cursor: pointer;">
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="graphcontains2">
          <div class="custom-select" @click="toggleOptions1">
            <div style="font-size: 1vw;width: 10vw;">飞机类型:</div>
            <div style="width: 20vw;position: relative;">
              <img src="../assets/img/graphInput.png" style="position: absolute;z-index: 99;width:100%;height: 100%;">
              <div class="selected-option">
        ...
        <div class="graphcontains2">
          <div class="custom-select" @click="toggleOptions3">
            <div style="font-size: 1vw;width: 10vw;">飞机载荷:</div>
            <div style="width: 20vw;position: relative;">
              <img src="../assets/img/graphInput.png" style="position: absolute;z-index: 99;width:100%;height: 100%;">
              ...
              <ul class="level-2" v-show="item.expanded" style="margin-left: 1vw;">
                <li v-for="(subItem, subIndex) in item.children" :key="'level2-' + subIndex">
                  <label style="font-size: 0.8vw;">
                    <input style="position: relative;width: 1vw;" type="radio" :checked="item.selectedChild === subItem"
                      @change="handleSelect(item, subItem)">
                    {{ subItem.label }}
                  </label>
                </li>
              </ul>
        ...
        <div
          style="width: 10vw;background-color: #00f6ff;height: 1.7vw;line-height: 1.7vw;border-radius: 1vw;text-align: center;margin-left: 1vw;cursor: pointer;"
          @click="sumbitChoose()">查询
        </div>
        <div
          style="background-color: #00f6ff;height: 1.7vw;line-height: 1.7vw;border-radius: 1vw;text-align: center;margin-left: 1vw;cursor: pointer;width:10vw"
          @click="clear()">重置
        </div>

      </div>
      <div
        style="width: 6%;display: flex;flex-direction: row;position: absolute;height: 1.7vw;right: 3vw;z-index: 2000;justify-content: space-around;margin-top: 1.2%;">
        ...
        <!--          </div>-->
        <!--        </div>-->
        <div style="width:100%;cursor: pointer" v-if="userType == 1">
          <div
            style="height: 1.7vw;width: 100%;background-color: transparent;border-radius: 1vw;display: flex;flex-direction: row;justify-content: center;padding: 0vw 0.1vw;border: 1px #2ed0d6 solid;justify-items: center;align-items: center;"
            @click="openFileInput">
            <img src="../assets/img/Inicon.png" style="height: 60%;object-fit: contain;">
      ...
      <div class="rightContent">
        <div class="rightList">
          <div class="tupu">
            <div style="width: 100%;height: 100%;background-color: #Ffffff;border-radius: 1vw;">
              <!-- <div class="gContainer"> -->
              <RelationGraph ref="graphRef" :options="graphOptions" :on-node-expand="onNodeExpand"
                :on-line-collapse="onNodeCollapse">
                <template #node="{ node }">
                  <div v-if="node.data.type == 0 && node.data.group == '1'"
                    style="font-size: 2.8vw;display: flex;justify-content: center;align-items: center;width: 100%;height: 100%;cursor: pointer"
                    @dblclick="showPopup(node)">
                    {{ node.text }}
                  </div>
                  <div v-if="node.data.type == 0 && node.data.group == '2'"
                    style="font-size: 2.8vw;display: flex;justify-content: center;align-items: center;width: 100%;height: 100%;cursor: pointer"
                    @dblclick="showPopup(node)">
                    {{ node.text }}
                  </div>
                  <div v-if="node.data.type == 0 && node.data.group == '3'"
                    style="font-size: 2.8vw;display: flex;justify-content: center;align-items: center;width: 100%;height: 100%;cursor: pointer"
                    @dblclick="showPopup(node)">
                    {{ node.text }}
                  </div>
                  <div v-if="node.data.type == 0 && node.data.group == '4'"
                    style="font-size: 2.8vw;display: flex;justify-content: center;align-items: center;width: 100%;height: 100%;cursor: pointer"
                    @dblclick="showPopup(node)">
                    {{ node.text }}
                  </div>
                  <div v-if="node.data.type == 0 && node.data.group == '5'"
                    style="font-size: 2.8vw;display: flex;justify-content: center;align-items: center;width: 100%;height: 100%;cursor: pointer"
                    @dblclick="showPopup(node)">
                    {{ node.text }}
                  </div>
                  <div v-if="node.data.type == 0 && node.data.group == '6'"
                    style="font-size: 2.8vw;display: flex;justify-content: center;align-items: center;width: 100%;height: 100%;cursor: pointer"
                    @dblclick="showPopup(node)">
                    {{ node.text }}
                  </div>
                  <div v-if="node.data.type == 0 && node.data.group == '7'"
                    style="font-size: 2.8vw;display: flex;justify-content: center;align-items: center;width: 100%;height: 100%;cursor: pointer"
                    @dblclick="showPopup(node)">
                    {{ node.text }}
                  </div>
                  ...
                  <div v-if="node.data.type == 2 && node.data.group == '1'"
                    style="font-size: 1.5vw;height: 100%;width: 100%;display: flex;justify-content: center;justify-items: center;"
                    @dblclick="showPopup(node)" @mousedown="handleDrag(node)" @mousemove="handleMove()"
                    @mouseup="endDrag" @mouseleave="endDrag">
                    <div style="height: 5%;margin-top: 40%;">{{ node.text }}</div>
                  </div>
                  <div v-if="node.data.type == 3 && node.data.group == '1'"
                    style="font-size: 1.5vw;height: 100%;width: 100%;display: flex;justify-content: center;justify-items: center;"
                    @dblclick="showPopup(node)" @mousedown="handleDrag(node)" @mousemove="handleMove()"
                    @mouseup="endDrag" @mouseleave="endDrag">
                    <div style="height: 5%;margin-top: 40%;">{{ node.text }}</div>
                  </div>
                  <div v-if="node.data.type == 4 && node.data.group == '1'"
                    style="font-size: 1.5vw;height: 100%;width: 100%;display: flex;justify-content: center;justify-items: center;"
                    @dblclick="showPopup(node)" @mousedown="handleDrag(node)" @mousemove="handleMove()"
                    @mouseup="endDrag" @mouseleave="endDrag">
                    <div style="height: 5%;margin-top: 40%;">{{ node.text }}</div>
                  ...
                  <div v-if="node.data.type == 2 && node.data.group == '2'"
                    style="font-size: 1.5vw;height: 100%;width: 100%;display: flex;justify-content: center;justify-items: center;"
                    @dblclick="showPopup(node)" @mousedown="handleDrag(node)" @mousemove="handleMove()"
                    @mouseup="endDrag" @mouseleave="endDrag">
                    <div style="height: 5%;margin-top: 40%;">{{ node.text }}</div>
                  </div>
                  <div v-if="node.data.type == 3 && node.data.group == '2'"
                    style="font-size: 1.5vw;height: 100%;width: 100%;display: flex;justify-content: center;justify-items: center;"
                    @dblclick="showPopup(node)" @mousedown="handleDrag(node)" @mousemove="handleMove()"
                    @mouseup="endDrag" @mouseleave="endDrag">
                    <div style="height: 5%;margin-top: 40%;">{{ node.text }}</div>
                  </div>
                  <div v-if="node.data.type == 4 && node.data.group == '2'"
                    style="font-size: 1.5vw;height: 100%;width: 100%;display: flex;justify-content: center;justify-items: center;"
                    @dblclick="showPopup(node)" @mousedown="handleDrag(node)" @mousemove="handleMove()"
                    @mouseup="endDrag" @mouseleave="endDrag">
                    <div style="height: 5%;margin-top: 40%;">{{ node.text }}</div>
                  ...
                  <div v-if="node.data.type == 2 && node.data.group == '3'"
                    style="font-size: 1.5vw;height: 100%;width: 100%;display: flex;justify-content: center;justify-items: center;"
                    @dblclick="showPopup(node)" @mousedown="handleDrag(node)" @mousemove="handleMove()"
                    @mouseup="endDrag" @mouseleave="endDrag">
                    <div style="height: 5%;margin-top: 40%;">{{ node.text }}</div>
                  </div>
                  <div v-if="node.data.type == 3 && node.data.group == '3'"
                    style="font-size: 1.5vw;height: 100%;width: 100%;display: flex;justify-content: center;justify-items: center;"
                    @dblclick="showPopup(node)" @mousedown="handleDrag(node)" @mousemove="handleMove()"
                    @mouseup="endDrag" @mouseleave="endDrag">
                    <div style="height: 5%;margin-top: 40%;">{{ node.text }}</div>
                  </div>
                  <div v-if="node.data.type == 4 && node.data.group == '3'"
                    style="font-size: 1.5vw;height: 100%;width: 100%;display: flex;justify-content: center;justify-items: center;"
                    @dblclick="showPopup(node)" @mousedown="handleDrag(node)" @mousemove="handleMove()"
                    @mouseup="endDrag" @mouseleave="endDrag">
                    <div style="height: 5%;margin-top: 40%;">{{ node.text }}</div>
                  ...
                  <div v-if="node.data.type == 2 && node.data.group == '4'"
                    style="font-size: 1.5vw;height: 100%;width: 100%;display: flex;justify-content: center;justify-items: center;"
                    @dblclick="showPopup(node)" @mousedown="handleDrag(node)" @mousemove="handleMove()"
                    @mouseup="endDrag" @mouseleave="endDrag">
                    <div style="height: 5%;margin-top: 40%;">{{ node.text }}</div>
                  </div>
                  <div v-if="node.data.type == 3 && node.data.group == '4'"
                    style="font-size: 1.5vw;height: 100%;width: 100%;display: flex;justify-content: center;justify-items: center;"
                    @dblclick="showPopup(node)" @mousedown="handleDrag(node)" @mousemove="handleMove()"
                    @mouseup="endDrag" @mouseleave="endDrag">
                    <div style="height: 5%;margin-top: 40%;">{{ node.text }}</div>
                  </div>
                  <div v-if="node.data.type == 4 && node.data.group == '4'"
                    style="font-size: 1.5vw;height: 100%;width: 100%;display: flex;justify-content: center;justify-items: center;"
                    @dblclick="showPopup(node)" @mousedown="handleDrag(node)" @mousemove="handleMove()"
                    @mouseup="endDrag" @mouseleave="endDrag">
                    <div style="height: 5%;margin-top: 40%;">{{ node.text }}</div>
                  ...
                  <div v-if="node.data.type == 2 && node.data.group == '5'"
                    style="font-size: 1.5vw;height: 100%;width: 100%;display: flex;justify-content: center;justify-items: center;"
                    @dblclick="showPopup(node)" @mousedown="handleDrag(node)" @mousemove="handleMove()"
                    @mouseup="endDrag" @mouseleave="endDrag">
                    <div style="height: 5%;margin-top: 40%;">{{ node.text }}</div>
                  </div>
                  <div v-if="node.data.type == 3 && node.data.group == '5'"
                    style="font-size: 1.5vw;height: 100%;width: 100%;display: flex;justify-content: center;justify-items: center;"
                    @dblclick="showPopup(node)" @mousedown="handleDrag(node)" @mousemove="handleMove()"
                    @mouseup="endDrag" @mouseleave="endDrag">
                    <div style="height: 5%;margin-top: 40%;">{{ node.text }}</div>
                  </div>
                  <div v-if="node.data.type == 4 && node.data.group == '5'"
                    style="font-size: 1.5vw;height: 100%;width: 100%;display: flex;justify-content: center;justify-items: center;"
                    @dblclick="showPopup(node)" @mousedown="handleDrag(node)" @mousemove="handleMove()"
                    @mouseup="endDrag" @mouseleave="endDrag">
                    <div style="height: 5%;margin-top: 40%;">{{ node.text }}</div>
                  ...
                  <div style="display: flex; justify-content: center; flex-wrap: nowrap; width: 100%;">
                    <div v-if="node.data.type == 0 && node.data.hasJs" @click="goToJsPage(node.data.docId)"
                      style="cursor: pointer;">
                      <img src="http://127.0.0.1:10035/profile/jsq.png" style="width: 2vw;height: 4vh">
                    </div>
                    <div v-if="node.data.type == 0 && node.data.hasTw" @click="goToTwPage(node.data.id)"
                      style="cursor: pointer;">
                      <img src="http://127.0.0.1:10035/profile/tw.png" style="width: 2vw;height: 4vh">
                    </div>
                    <div v-if="node.data.type == 0 && node.data.hasSp" @click="goToSpPage(node.data.docId)"
                      style="cursor: pointer;">
                      <img src="http://127.0.0.1:10035/profile/videoPic.png" style="width: 2vw;height: 4vh">
                    </div>
                    <div v-if="node.data.type == 0 && node.data.hasDh" @dblclick="showPopup(node)"
                      style="cursor: pointer;" @click="goToDhPage(node.data.docId)">
                      <img src="http://127.0.0.1:10035/profile/dhvideoPic.png" style="width: 2vw;height: 4vh">
                    </div>
                  </div>
            ...
            <el-form label-width="90px">
              ...
              <el-form-item label="类型">
                <el-select v-model="typeValue" placeholder="请选择类型">
                  ...
                  <el-option label="数值计算" value="js"></el-option>
                </el-select>
              </el-form-item>
              ...
              <el-form-item label="数值计算地址" v-if="this.typeValue == 'js'">
          ...
          <el-dialog title="修改分支内容" :visible.sync="isModalVisible2" append-to-body top="1vh" style="height: 55vw;"
            ...
            <el-form label-width="90px">
              ...
              <el-form-item style="position: relative ;" label="数值计算类别" v-if="this.editType == 'js'">
              ...
              <el-form-item label="数值计算地址" v-if="this.editType == 'js'">
...
import { getDomainGraphNew, createNodeAndRelationship, getgraphInfo, getGraphByKeywords, drawTuPu } from "@/api/login";
...
export default {
    ...
    return {
      ...
      items: [
        ...
        },
        {
          ...
          selectedChild: null,
          children: [
            { label: '机载雷达',  value: '机载雷达' },
            { label: '吊放声呐',  value: '吊放声呐' },
            { label: '声呐浮标',  value: '声呐浮标' },
            { label: '光电探头',  value: '光电探头' }
          ]
        },
        {
          label: '攻击载荷',
          ...
          selectedChild: null,
          children: [
            { label: '航空鱼雷',  value: '航空鱼雷' },
            { label: '航空导弹',  value: '航空导弹' }
          ]
        }
      ],
      ...
      useMove: 0,
      parentType: null,
      jsInfoList: ['QJFXT', 'DBDLC', 'LDWLT', 'SNJS', 'SN1', 'DQJS', 'YLDQGJ', 'DDZZSYFZJC'],
  ...
  mounted() {
    ...
    if (localStorage.getItem("keywords") != null) {
      ...
      getGraphByKeywords(dataInfo).then((res) => {
        console.log("222")
      ...
      if (localStorage.getItem("taskType") != null) {
        this.selectedOption2 = JSON.parse(localStorage.getItem("taskType"))
        this.selectedOption2.text = this.selectedOption2.label;
        console.log(this.selectedOption2)
      }
      if (localStorage.getItem("plane") != null) {
        this.selectedOption1 = JSON.parse(localStorage.getItem("plane"))
        this.selectedOption1.text = this.selectedOption1.label;
        console.log(this.selectedOption1);
      }
      if (localStorage.getItem("chooseList") != null) {
        var results = JSON.parse(localStorage.getItem("chooseList"))
        for(let i = 0;i < results.length;i++){
          for(let j = 0;j < this.items.length;j++){
            for(let k = 0;k < this.items[j].children.length;k++){
              if(results[i].label == this.items[j].children[k].label){
                this.items[j].selectedChild = this.items[j].children[k];
              }
            }
          }
        }
      ...
      if (localStorage.getItem("taskType") != null || localStorage.getItem("plane") != null || localStorage.getItem("chooseList") != null) {
        const info1 = [];
        const info2 = [];
        for (let a = 0; a < this.items.length; a++) {
        const currentInfo = this.items[a];
        if (currentInfo.selectedChild != null) {
          if (currentInfo.selectedChild.label != "航空鱼雷" && currentInfo.selectedChild.label != "航空导弹") {
            info1.push(currentInfo.selectedChild.label);
          } else {
            info2.push(currentInfo.selectedChild.label);
          }
        }
      }
        dataInfo = {
          "type": this.selectedOption2.label,
          "plane": this.selectedOption1.value,
          "info": {
            "info1": info1,
            "info2": info2,
          }
  ...
  methods: {
    goToJsPage(parentId) {
      ...
      if (this.selectedOption2 != null) {
        localStorage.setItem("taskType", JSON.stringify({
          label: this.selectedOption2.label,
          value: this.selectedOption2.value
        }))
      }
      if (this.selectedOption1 != null) {
        localStorage.setItem("plane", JSON.stringify({
          label: this.selectedOption1.label,
          value: this.selectedOption1.value
        }))
      }
      var chooseList = [];
      for (let i = 0; i < this.items.length; i++) {
        if (this.items[i].selectedChild != null) {
          chooseList.push(this.items[i].selectedChild);
        }
      }
      if (chooseList.length > 0) {
        localStorage.setItem("chooseList", JSON.stringify(chooseList))
      }
      this.$router.push({ path: '/JsInfo', query: { parentId: parentId, type: 4 } })
    },
    goToTwPage(parentId) {
      ...
      this.$router.push({ path: '/TwInfo', query: { id: parentId, type: 1 } })
    },
    goToSpPage(parentId) {
      if (this.keywords != '') {
        localStorage.setItem("keywords", this.keywords)
      ...
      this.$router.push({ path: '/SpInfo', query: { parentId: parentId, type: 2 } })
    },
    goToDhPage(parentId) {
      if (this.keywords != '') {
        localStorage.setItem("keywords", this.keywords)
      ...
      this.$router.push({ path: '/DhInfo', query: { parentId: parentId, type: 3 } })
    },
    handleDrag(node) {
      // 初始化状态
    ...
    handleSelect(parentItem, childItem) {
      // 这里可以添加选择后的逻辑
      // console.log('选中:', item.label, '状态:', item.selected);

      parentItem.selectedChild = childItem;
      parentItem.selectedChild.selected = true;
      console.log(this.items)
      ...
      //       have = 1
      //       this.chooseList.removeItem(item.label)
      //       break;
      //     }
      //   }
      //   if (have == 0) {
    ...
    selectOption1(option) {
      ...
      if (this.selectedOption2.text == "DQGJ") {
        this.items = [
          {
            label: '通信载荷',
            expanded: false,
      ...
      if (this.selectedOption2.text == "DQSS") {
      ...
      if (this.selectedOption2.text == "DHGJ") {
        this.items = [
          {
            label: '通信载荷',
            expanded: false,
      ...
      if (this.selectedOption2.text == "YJZC") {
        this.items = [
          {
            label: '通信载荷',
            expanded: false,
    ...
    selectOption3(option) {
      ...
      console.log(this.selectedOption3.text)
    },
    ...
    zhengl(data) {
      ...
      if (nodeList != undefined) {
        ...
        var startX1 = -(leve1Nodes.length * 370) / 2; // 居中起始位置
        leve1Nodes.forEach((node, index) => {
          ...
          nodes.push({
            ...
            text: node.name,
            level: 1,
            x: startX1 + index * 370, // 水平等距排列
            y: -700,                 // leve1 的固定 Y 坐标
            fixed: true,            // 固定位置
        ...
        var startX2 = -(leve2Nodes.length * 370) / 2 - 1000; // 居中起始位置
        leve2Nodes.forEach((node, index) => {
          ...
          nodes.push({
            ...
            text: node.name,
            level: 2,
            x: startX2 + index * 370, // 水平等距排列
            y: -200,                 // leve2 的固定 Y 坐标
            fixed: true,            // 固定位置
            data: { ...node },
            ...style
          });
        ...
        var startX3 = -(leve3Nodes.length * 600) / 2 - 300; // 居中起始位置
        leve3Nodes.forEach((node, index) => {
          ...
          nodes.push({
            ...
            text: node.name,
            level: 3,
            x: startX3 + index * 500, // 水平等距排列
            y: 300,                 // leve3 的固定 Y 坐标
            fixed: true,            // 固定位置
            data: { ...node },
            width: 280,
            height: 280,
        ...
        var startX4 = -(leve4Nodes.length * 350) / 2 - 800; // 居中起始位置
        ...
        var startX6 = -(leve6Nodes.length * 290) / 2 - 700; // 居中起始位置
        leve6Nodes.forEach((node, index) => {
          nodes.push({
            id: node.id,
            text: node.name,
            level: 6,
            x: startX6 + index * 290, // 水平等距排列
            y: 2200,                 // leve6 的固定 Y 坐标
            fixed: true,            // 固定位置
            data: { ...node },
            width: 280,
            height: 280,
            color: '#003ea4',
            font: 'normal 558px Arial',
            fontColor: '#ffffff'
          });
        });
        console.log(nodes)
        for (let i = 0; i < nodes.length; i++) {
          ...
          drawTuPu(element).then(list => {
            console.log(list)
            if (list != undefined) {
              for (let j = 0; j < list.data.length; j++) {
                const element1 = list.data[j];
                // console.log(element1)
                if (element1.type === 1) {
                  element.data.hasTw = true;
                  // console.log(element)
                }
                if (element1.type === 2) {
                  element.data.hasSp = true;
                  console.log("element")
                }
                if (element1.type === 3) {
                  element.data.hasDh = true;
                  // console.log("donghua")
                }
                if (element1.type === 4) {
                  // console.log("进来了")
                  element.data.hasJs = true;
                  // console.log("jisuan")
                }
              }
            } else {
        ...
        // var node1 = nodeList.filter(node => node.name == "QJ3");
        // console.log(node1)
        ...
        //   });
        // });
        // var NodesText3 = nodeList.filter(node => (node.group === '3' && node.type != 0) || (node.group === '2' && node.type != 0));
    ...
    async openAdd() {
      ...
      this.parentType = this.nodeInfo.type;
    ...
    clear() {
      ...
      for (let i = 0; i < this.items.length; i++) {
        ...
        for (let j = 0; j < children.length; j++) {
          const zaiHe = children[j];
          zaiHe.selected = false;
        }
      }
      let params = {};
      getgraphInfo(params).then((res) => {
    ...
    async addNewBranch() {
      this.isModalVisible = false;
      console.log(this.newBranchContent)
    ...
    getNodeStyle(group) {
      const styles = [
        { width: 280, height: 280, color: "#ef7a43", fontColor: '255,255,255', size: '60px' },
        { width: 280, height: 280, color: '#ffa384', font: 'normal 40px Arial', fontColor: '0,0,0' },
        { width: 280, height: 280, color: '#00f6ff', font: 'normal 50px Arial', fontColor: '0,0,0' },
        { width: 280, height: 280, color: '#00c6ff', font: 'normal 40px Arial', fontColor: '0,0,0' },
        { width: 280, height: 280, color: '#2a98ff', font: 'normal 32px Arial', fontColor: '#ffffff' },
        { width: 280, height: 280, color: '#005fb7', fontSize: '1.5vw', fontColor: '#ffffff', display: 'flex', alignItems: 'center', justifyContent: 'center' },
        { width: 280, height: 280, color: '#003ea4', font: 'normal 28px Arial', fontColor: '#ffffff' },
        { width: 280, height: 280, color: '#7df887', font: 'normal 28px Arial', fontColor: '#000000' }
      ];
...
::v-deep .rel-toolbar {
  color: #ffffff;
  background: rgba(0, 108, 218, 0.73);
...
.relation-graph /deep/.rel-easy-view {
